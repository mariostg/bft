import pytest
from lineitems.forms import CostCenterLineItemUploadForm, FundCenterLineItemUploadForm
...
class TestCostCenterLineItemUpload:
    ...
    def setup(self):
        ...
        self.files = {
            "source_file": SimpleUploadedFile("file.txt", b"file-content", content_type="text/plain")
        }
